module Matrix_op
  ...
  function cholesky(A) result(G)

    implicit none
    double precision, dimension(:,:) :: A
    integer :: n
    double precision, dimension(:,:), allocatable :: G  ! Displacement result.
    integer    :: i,j
  ...
  subroutine inv_chol(G,b)
    ...
    ! G is the Cholesky decomposition of a given matrix.
    ! vector solution is saved in "b"
